        ...
        <nav class="main-nav flex item-center">
            ...
            <?php if ( class_exists( 'WooCommerce' ) && is_shop() ) : ?>
                <div class="shop-header-icons flex item-center" style="gap: 20px;">
                    <a href="<?php echo esc_url( get_permalink( get_option('woocommerce_myaccount_page_id') ) ); ?>" class="shop-icon" title="My Account">
                    ...
                    <a href="#" class="shop-icon wishlist-trigger" title="Wishlist">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="22" height="22">
